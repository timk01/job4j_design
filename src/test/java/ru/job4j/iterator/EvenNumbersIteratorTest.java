...
class EvenNumbersIteratorTest {
    ...
    @BeforeEach
    public void setUp() {
        iterator = new EvenNumbersIterator(new int[] {1, -3, 2, 3, 5, 5, -4, 5, 6, 7, -11, 13});
    }
    ...
    @Test
    void sequentialNextInvocationDoesntAffectRetrievalOrder() {
        assertThat(iterator.next()).isEqualTo(2);
        assertThat(iterator.next()).isEqualTo(-4);
        assertThat(iterator.next()).isEqualTo(6);
        assertThatThrownBy(iterator::next)
    ...
    @Test
    void sequentialHasNextInvocationWorksFine() {
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.hasNext()).isTrue();
        assertThat(iterator.hasNext()).isTrue();
